// ============================================================
//  已废弃（DEPRECATED）
//  本工具仅适用于 v6.2.0 及更早的单文件结构。
//  v6.2.0 起项目改为「src/ 模块化源码 + build.js 拼接」：src/ 是唯一源码来源，
//  本工具的 PARTS 行号基于拆分前的历史单文件，v6.2.0 之后的任何改动都会使其失效。
//  请勿运行。如需回溯历史单文件，请 checkout 对应 tag（≤ v6.2.0）。
// ============================================================
